...
public class TimeServiceTests
{
  ...
  {
    assertEquals(theBase.toInstant().toEpochMilli(),
                 ts.getBase(), "correct base");
  ...
  {
    long offset = ts.getCurrentTime().toEpochMilli()
            - theBase.toInstant().toEpochMilli();
  ...
  public void testSetClockParamsGood ()
  {
    ...
    long newBase =
            theBase.toInstant().plusMillis(TimeService.DAY).toEpochMilli();
  ...
  public void testTimePass() 
  {
    try {
      ...
      ts.updateTime();
      long delay = ts.getCurrentTime().toEpochMilli()
              - theBase.toInstant().toEpochMilli();
